...
def run_report(inputdate):
    ...
    msg["To"] = "tbobbili@relyonanchor.com; Shimpy <shimpy@relyonanchor.com>"
    # Add Body
    msg.attach(MIMEText(
    ...
    s.sendmail("tbobbili@relyonanchor.com", "tbobbili@relyonanchor.com; Shimpy <shimpy@relyonanchor.com>", msg.as_string())
    s.quit()
    ...
    newMail.Subject = "Stingray Daily Claims report - " + subjectname
    ...
    attachment1 = ("C:/Users/tbobbili/Desktop/Task/Stingray Daily Claims Report SRD-876/Stingray Daily Claims report - " + filename + ".xls")
